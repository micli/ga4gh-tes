    ...
    public class Deployer
    {
        ...
        public async Task<int> DeployAsync()
        {
            ...
            try
            {
                ...
                this.azEnv = AzureEnvironment.FromName(this.configuration.AzureName);
        ...
        private void ValidateInitialCommandLineArgsAsync()
        {
            ...
            void ThrowIfAzureEnvironmentNotExists(string azureEnvironmentName)
            {
                if (!AzureEnvironmentExtension.IsEnvironmentNameAvailable(azureEnvironmentName))
                {
                    throw new ValidationException($"Specified cloud {azureEnvironmentName} does not exist.");
                }
            }
            ...
            ThrowIfAzureEnvironmentNotExists(configuration.AzureName);
